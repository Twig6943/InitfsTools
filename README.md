...
**For why this is taking so long, I am currently rewriting the entire project from C# to C++20**
...
- **Type Extractor** — Extract all types and commands from a game executable or Frosty SDK DLL [IN BETA RELEASE]
